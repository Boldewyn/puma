...
<?php echo form_open($exportCommand.'bibtex') ?>
  <p><input type="submit" class="submit" name="BibTeX" title="<?php _e('Export to BibTeX')?>" value="<?php _e('BibTeX')?>" /></p>
</form>
<?php echo form_open($exportCommand.'ris') ?>
  <p><input type="submit" class="submit" name="RIS" title="<?php _e('Export to RIS')?>" value="<?php _e('RIS')?>" /></p>
</form>
<?php if ($userlogin->hasRights('export_email')):
  echo form_open($exportCommand.'email') ?>
  <p><input type="submit" class="submit" name="E-mail" title="<?php _e('Export by e-Mail')?>" value="<?php _e('E-mail')?>" /></p>
</form>
<?php endif; ?>
<hr/>
