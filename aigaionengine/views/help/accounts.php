...
<div id="help-content">
  ...
  <p><?php _e('Users with sufficient rights ('user_edit_all') can subscribe a group to certain topics from the &lsquo;manage accounts&rsquo; page. In that case all users that belong to that group will be counted &lsquo;subscribed&rsquo; to that topic, no matter whether they were individually subscribed or not.')?></p>
