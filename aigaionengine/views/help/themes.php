...
<div id="help-themes" class="help-content regular-text">
  <h2><?php _e('Themes')?></h2>
...
[new-theme-directory]/img/
  ...
  <p>Note that the personal configuration forms will automatically pick up the new theme as an option.</p>
