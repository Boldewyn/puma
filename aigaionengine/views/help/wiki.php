...
<div id="help-wiki" class="help-content regular-text">
  ...
  <p><?php printf(__('The wiki allows additionally a subset of LaTeX commandos to be used. The recognized commandos are mostly text styles, like %s, or escape sequences, like %s.'), '<code>\\textbf{}</code>', sprintf('<code>\\ss</code> %1$s <code>ß</code> %s <code>\\alpha</code> %1$s <code>&alpha</code>', 'for', 'or')) ?></p>
</div>
