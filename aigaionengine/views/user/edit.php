...
<div class="user_edit">
  ...
  <?php echo form_open("user/{$user->login}/edit", array("autocomplete"=>"off")); ?>
    <?php /* <fieldset class="extended_label">
      ...
      <p>
        <label class="block" for="user_edit_password"><?php _e('Password (leave blank to keep)')?></label>
        <input type="password" class="text password" name="password" id="user_edit_password" />
      </p>
      <p>
        <label class="block" for="user_edit_password_check"><?php _e('Re-type new password')?></label>
    ...
    <fieldset class="extended_label bordered half column">
      ...
      <p>
        <label class="block" for="user_edit_summarystyle"><?php _e('Publication summary style')?></label>
      ...
      <p>
        <label class="block" for="user_edit_authordisplaystyle"><?php _e('Author display style')?></label>
      ...
      <p>
        <label class="block" for="user_edit_liststyle"><?php _e('Number of publications per page')?></label>
      ...
      <p>
        <label class="block" for="user_edit_exportinbrowser"><?php _e('Open export data in browser')?></label>
      ...
      <p>
        <label class="block" for="user_edit_utf8bibtex"><?php _e('Export BibTeX as UTF8')?></label>
    ...
    <p>
      <input type="submit" value="<?php _e("Store new settings")?>" />
