...
<?php echo form_open('wiki/Edit:'.h($item), array('class'=>'extralarge_input')); ?>
  <p>
    <textarea name="content" rows="10" cols="30"><?php echo set_value('content', $original_content); ?></textarea>
  </p>
  <p>
