...
Additional bugs added by Manuel Strehl, 2010.
*/
(function () {
...
var LaTeXMathML = window.LaTeXMathML = function (options) {
    ...
    var showasciiformulaonhover = options.showlatex || true; // helps students learn ASCIIMath
    ...
    function AMcreateElementXHTML(t) {
      if (! isIE) return document.createElementNS("http://www.w3.org/1999/xhtml",t);
    ...
    */
    ...
    function AMparseMath(str) {
      ...
      if (mathfontfamily != "" && (isIE || mathfontfamily != "serif")) {
        ...
        fnode.setAttribute("style","font-family:"+mathfontfamily);
    ...
    if ('autostart' in options && options.autostart == true) {
        this.init();
    }
...
window.onload = function () { new LaTeXMathML({autostart:1}); };
